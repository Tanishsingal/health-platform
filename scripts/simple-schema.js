...
async function initializeSchema() {
  console.log('🏥 Initializing Healthcare Database Schema (Simplified)');
  console.log('====================================================');

  try {
    // Create enums
    await runSQL(`CREATE TYPE user_role AS ENUM ('patient', 'doctor', 'nurse', 'admin_staff', 'pharmacist', 'lab_technician', 'cleaning_staff', 'maintenance_staff', 'sales_procurement', 'public_health_admin', 'super_admin');`, 'Creating user_role enum');
